...
.ac-tool .tool-dados-stack{display:flex;flex-direction:column;gap:24px}
      ...
      <div class="tool-main__inner">
        ...
        <section class="tool-panel is-active" role="tabpanel" data-panel="dados">
          <div class="tool-panel__inner">
            <div class="tool-dados-stack">
              <div id="dados-header-root"></div>
...
export async function render(rootEl){
  ...
  const headerRoot = host.querySelector("#dados-header-root");
  if(headerRoot){
    try{
