...
(function(){
  ...
  // liga inputs -> estado -> storage -> bind
  const map = [
  ...
  // copiar/baixar etiqueta (opcional, já funciona com o HTML que você tem)
